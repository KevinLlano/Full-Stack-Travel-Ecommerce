...
export class ExcursionDetailComponent implements OnInit {
  ...
  vacationUrl: string = environment.URL + '/api/vacations' || '/api/vacations';
  excursionsUrl = environment.URL + '/api/excursions/' || "/api/excursions/"
  cartItemsUrl: string = environment.URL + '/api/cartItems' || '/api/cartItems';
