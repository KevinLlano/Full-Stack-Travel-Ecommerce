...
VALUES (default, default, "Visit the beautiful country of Italy",
...
VALUES (default, default, 100, "Cheese Tour",
...
CREATE
USER IF NOT EXISTS 'ecommerceapp'@'localhost' IDENTIFIED BY 'ecommerceapp';
GRANT
SELECT,
INSERT
,
UPDATE,
DELETE, EXECUTE
on `full-stack-ecommerce`.* TO 'ecommerceapp'@'localhost';
